...
{
    fprintf(out,
        "Usage: " PGPID_MIP_NAME " update_trustdb [OPTIONS]... [OWNERTRUST.GPG]...\n"
        "\n"
...
{
    char status_path[] = "/tmp/pgpid-mip-status-XXXXXX";
...
int pgpid_action_update_trustdb(int argc, char **argv)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (!strcmp(a, "--batch")) {
            ...
            pgpid_error("Try '" PGPID_MIP_NAME " update_trustdb --help' for more information.");
            return PGPID_USAGE;
