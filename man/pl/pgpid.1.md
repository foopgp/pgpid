...
Poświadczyć kogoś innego. Oba operandy są opcjonalne i mogą wystąpić w
dowolnej kolejności — rozpoznaje się je po kształcie, nie po miejscu.
Brakujące dane są pytane, chyba że --batch mówi, że nie ma kogo pytać.

TARGET_KEYFPR to pełne czterdzieści znaków, odczytane z karty drugiej
osoby — nigdy wzorzec wyszukiwania, bo poświadczenia nie da się cofnąć.
Bez niego szuka się tutaj i na serwerach kluczy tego, kto nosi TARGET_U4,
i prosi się o osiem znaków odcisku palca, wziętych z losowo wybranego
miejsca: tyle, by dowieść, że karta jest w twojej dłoni.

TARGET_U4 można zapisać jako u4WARTOŚĆ, odradzane u4=WARTOŚĆ albo samą
wartość. Podany razem z odciskiem palca wymaga, by certyfikat go nosił, a
w przeciwnym razie odmawia.
