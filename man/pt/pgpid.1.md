...
Certificar outra pessoa. Ambos os operandos são facultativos e podem vir em
qualquer ordem — são reconhecidos pela sua forma, não pelo seu lugar. O que
falta é perguntado, a não ser que --batch diga que não há ninguém a quem
perguntar.

TARGET_KEYFPR são os quarenta caracteres inteiros, lidos no cartão da outra
pessoa — nunca um padrão de pesquisa, porque uma certificação não se
retira. Sem ele, procura-se aqui e nos servidores de chaves quem traz
TARGET_U4, e pedem-se oito caracteres da impressão digital, tomados num
lugar sorteado: o bastante para provar que o cartão está na sua mão.

TARGET_U4 pode escrever-se u4VALOR, o desaconselhado u4=VALOR, ou nu. Dado
juntamente com uma impressão digital, exige que o certificado o traga, e
