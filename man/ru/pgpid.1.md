...
порядке — их узнают по виду, а не по месту. Недостающее спрашивается, если
только --batch не говорит, что спрашивать некого.

TARGET_KEYFPR — это все сорок символов, прочитанные с карты другого
человека, а не шаблон поиска: заверение не отзывается. Без него того, кто
несёт TARGET_U4, ищут здесь и на серверах ключей, и спрашивают восемь
символов отпечатка, взятых в случайно выбранном месте: этого довольно,
чтобы доказать, что карта у вас в руке.

TARGET_U4 пишется как u4ЗНАЧЕНИЕ, устаревшее u4=ЗНАЧЕНИЕ или просто
значение. Вместе с отпечатком он требует, чтобы сертификат его нёс, и
иначе отказывает.
